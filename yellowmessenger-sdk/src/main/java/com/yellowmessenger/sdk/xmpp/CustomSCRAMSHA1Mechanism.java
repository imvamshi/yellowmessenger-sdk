package com.yellowmessenger.sdk.xmpp;

import com.yellowmessenger.sdk.xmpp.crypto.MAC;
...
public class CustomSCRAMSHA1Mechanism extends SASLMechanism {
    ...
    @Override
    public CustomSCRAMSHA1Mechanism newInstance() {
        return new CustomSCRAMSHA1Mechanism();
    }
